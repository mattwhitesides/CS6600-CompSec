...
\subsection{BLP}
For our Bell-LaPadula model we first define the security classifications our subjects and objects fall into. Given we are dealing with military records it makes sense to use the standard government security levels. In addition to security level subjects and objects will fall into categories based upon the appropriate work unit they fall under.  
Table 5 shows the security clearance levels and the subjects/objects at the given levels.
Table 6 shows the work unit categories each subject/object falls into.
