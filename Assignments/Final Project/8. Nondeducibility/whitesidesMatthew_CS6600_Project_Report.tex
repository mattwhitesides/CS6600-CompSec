...
Given both produce the same outputs at each iteration from the EC's perspective, he cannot deduce that the output came from another EC or the higher level MC thus making the system non-deducibly secure in regards to confidentiality.
