...
\begin{table*}[]
  ...
  4.  & $B_1I_{1,0} \sim fr$                                       & FRS trusts the FR from a verified user.                                     \\
  5.  & $T_{1,0} \sim fr$                                          & FRS trusts the FR.                                                          \\
  6.  & $B_1I_{1,0} \sim fr \bigwedge T_{1,0} \sim fr \rightarrow B_1 \sim fr$ & FRS believes the FR in the FRS.                                             \\
  7.  & $I_{1,1}fr$                                           & FRS logs everything is correct.                                             \\
  8.  & $B_1I_{1,1}fr$                                        & MC belives the FRS logs.                                                    \\
  9.  & $T_{1,1}fr$                                           & MC trusts the FR.                                                           \\
  10. & $B_1I_{1,1}fr \bigwedge T_{1,1}fr \rightarrow B_1 \sim fr$   & MC belives the FRS logs are correct but the FR is modified.                 \\
